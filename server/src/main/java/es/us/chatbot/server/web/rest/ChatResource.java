...
import es.us.chatbot.server.service.TalkService;
...
/**
 * REST controller for managing {@link es.us.chatbot.server.domain.Chat}.
 */
@RestController
@RequestMapping("/api")
public class ChatResource {
    ...
    public ChatResource(ChatRepository chatRepository, TalkService talkService) {
