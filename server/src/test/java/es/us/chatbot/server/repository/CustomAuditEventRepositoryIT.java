...
import es.us.chatbot.server.config.audit.AuditEventConverter;
import es.us.chatbot.server.domain.PersistentAuditEvent;
...
import static es.us.chatbot.server.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
